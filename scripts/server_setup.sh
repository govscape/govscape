...
poetry run python scripts/serving/run_gunicorn.py --data-directory ./data/prod --text_model BGE --visual_model CLIP --keyword_index_type SQLite --vector_index_type Memory
