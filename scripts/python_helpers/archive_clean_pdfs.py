...
if __name__ == '__main__':
    ...
    def list_digests(num_pages=1):
        ...
        while True:
            ...
            digest_batch = [os.path.split(os.path.split(key)[0])[1] for key in contents if key.endswith('.json')]
        ...
        for i in range(1, math.ceil(NUM_PAGES_TO_PROCESS / 1000)):
            ...
            for j in range(0, len(digests), BATCH_SIZE):
                ...
                with ProcessPoolExecutor(max_workers=num_workers) as executor:
                    futures = [executor.submit(copy_to_clean, args.backend, bucket_name, args.local_base_dir, dirty_data_prefix, clean_data_prefix, worker_batch) for worker_batch in worker_batches]
