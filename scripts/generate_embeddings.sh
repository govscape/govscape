...
poetry run python scripts/python_helpers/s3_embedding_pipeline.py --num_pages_to_process 5 --bucket_name 'bcgl-public-bucket' --pdf_dir 'archive/2020/PDFs/' --data_dir $data_dir --model_type 'BGE'
